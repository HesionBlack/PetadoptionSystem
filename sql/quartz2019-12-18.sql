...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RuoyiScheduler', 'bogon1576573246108', 1576573326772, 15000);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1576573250000, -1, 5, 'PAUSED', 'CRON', 1576573246000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1576573260000, -1, 5, 'PAUSED', 'CRON', 1576573246000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1576573260000, -1, 5, 'PAUSED', 'CRON', 1576573246000, 0, NULL, 2, '');
COMMIT;
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=125 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_pet` VALUES ('1', '二哈', '雪橇犬', '2019-12-16 14:36:46', 1, 0, 1, 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1576490779740&di=1ab8905079727e05e66db218b93b96cb&imgtype=0&src=http%3A%2F%2Fdingyue.nosdn.127.net%2FgDocjyIE%3DrAKuSnFNZbsZKpLVpRicfdP0hKbQbN1ZUPWT1523430130235.jpg', 'ruoyi', 'ruoyi', '2019-12-16 15:18:54', '这是一只二哈', '0');
INSERT INTO `sys_pet` VALUES ('2', '阿拉斯加犬', '雪橇犬', '2019-12-16 16:47:30', 1, 0, 1, 'https://ss1.baidu.com/6ONXsjip0QIZ8tyhnq/it/u=3834139921,1086274215&fm=173&app=49&f=JPEG?w=634&h=419&s=23A3DA05428754F198B9147D03008073', 'ruoyi', 'ruoyi', '2019-12-16 16:46:44', '这是雪橇三傻之一', '0');
INSERT INTO `sys_pet` VALUES ('4e1c7b2020a711ea972d02c5d9ef22d8', 'ff', 'ww', '2019-12-17 16:29:13', 0, 1, 1, 'http://127.0.0.1:8889/profile/upload/2019/12/17/70790eb4e84a0aa1afaabe1e319e7e99.jpeg', 'admin', NULL, NULL, 'w', '2');
INSERT INTO `sys_pet` VALUES ('64ddcd0020a211ea972d02c5d9ef22d8', '2', 'ww', '2019-12-17 15:54:04', 0, 1, 1, 'http://127.0.0.1:8889/profile/upload/2019/12/17/5bf8fbe586601e31f45abc239d66350a.jpeg', 'admin', NULL, NULL, 'sd', '2');
INSERT INTO `sys_pet` VALUES ('a140cb5a209611ea972d02c5d9ef22d8', 'w', 'ww', '2019-12-17 14:29:51', NULL, 1, 1, 'http://127.0.0.1:8889/profile/upload/2019/12/17/cfd2e4890b693a3d6e7ef1eaedfc3253.jpeg', 'admin', NULL, NULL, 'w', '2');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2019-12-17 15:26:05', 'admin', '2018-03-16 11:33:00', 'ry', '2019-12-17 15:26:05', '管理员');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user_online` VALUES ('48c842b7-4444-4cac-9cc7-a67b50158c5f', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome', 'Mac OS X', 'on_line', '2019-12-17 14:10:34', '2019-12-17 17:00:59', 1800000);
COMMIT;
