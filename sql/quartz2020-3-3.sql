...
Source Database       : petadopt

Target Server Type    : MYSQL
Target Server Version : 80018
File Encoding         : 65001

Date: 2020-03-03 21:53:38
*/
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'LAPTOP-6RGHAD0S1583229606005', '1583229879351', '15000');
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', null, '1583229610000', '-1', '5', 'PAUSED', 'CRON', '1583229606000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', null, '1583229615000', '-1', '5', 'PAUSED', 'CRON', '1583229606000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', null, '1583229620000', '-1', '5', 'PAUSED', 'CRON', '1583229606000', '0', null, '2', '');
...
INSERT INTO `sys_logininfor` VALUES ('212', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Mac OS X', '1', '验证码错误', '2019-12-21 08:30:53');
INSERT INTO `sys_logininfor` VALUES ('213', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Mac OS X', '0', '登录成功', '2019-12-21 08:30:56');
INSERT INTO `sys_logininfor` VALUES ('214', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Mac OS X', '0', '退出成功', '2019-12-21 08:32:31');
INSERT INTO `sys_logininfor` VALUES ('215', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Mac OS X', '0', '登录成功', '2019-12-21 08:32:34');
INSERT INTO `sys_logininfor` VALUES ('216', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Mac OS X', '1', '验证码错误', '2019-12-21 08:58:00');
INSERT INTO `sys_logininfor` VALUES ('217', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Mac OS X', '0', '登录成功', '2019-12-21 08:58:05');
INSERT INTO `sys_logininfor` VALUES ('218', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Mac OS X', '0', '登录成功', '2019-12-21 10:17:54');
INSERT INTO `sys_logininfor` VALUES ('219', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Mac OS X', '0', '登录成功', '2019-12-21 10:53:47');
...
INSERT INTO `sys_logininfor` VALUES ('233', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-02-17 14:18:15');
INSERT INTO `sys_logininfor` VALUES ('234', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-02-17 14:18:59');
INSERT INTO `sys_logininfor` VALUES ('235', 'ry', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-02-17 14:19:07');
INSERT INTO `sys_logininfor` VALUES ('236', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-02-17 15:32:13');
INSERT INTO `sys_logininfor` VALUES ('237', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-02-17 15:33:40');
INSERT INTO `sys_logininfor` VALUES ('238', 'ry', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-02-17 15:33:50');
...
INSERT INTO `sys_oper_log` VALUES ('198', '重置密码', '2', 'com.ruoyi.web.controller.system.SysUserController.resetPwd()', 'GET', '1', 'admin', '研发部门', '/system/user/resetPwd/2', '127.0.0.1', '内网IP', '{ }', '\"system/user/resetPwd\"', '0', null, '2020-02-17 14:18:51');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2020-02-17 15:32:14', 'admin', '2018-03-16 11:33:00', 'ry', '2020-02-17 15:32:13', '管理员');
INSERT INTO `sys_user` VALUES ('2', '105', 'ry', '若依', '00', 'ry@qq.com', '15666666666', '1', '', 'ce8a6bff0cfb7c927f7a3ab41822e6a6', '0e17b7', '0', '0', '127.0.0.1', '2020-02-17 15:33:50', 'admin', '2018-03-16 11:33:00', 'ry', '2020-02-17 15:33:50', '测试员');
...
-- ----------------------------
INSERT INTO `user_leavemsg` VALUES ('0348d84622fa11ea823e91afbb9bd661', '100', 'sdasd', '2019-12-20 15:26:18', '爱上', '1');
INSERT INTO `user_leavemsg` VALUES ('5b7db21623ae11eaaef9a7371ade0b99', '100', 'sd', '2019-12-21 12:57:15', 'sd', '1');
INSERT INTO `user_leavemsg` VALUES ('e0bc5df5515711ea8162a0510b8f993f', '2', '是', '2020-02-17 15:34:06', '是', '0');
...
-- ----------------------------
-- Records of user_leavemsg_reply
-- ----------------------------
INSERT INTO `user_leavemsg_reply` VALUES ('047217fa23a911eaaef9a7371ade0b99', '0348d84622fa11ea823e91afbb9bd661', '2019-12-21 12:19:02', '1', 'admin', 'hello啊ss');
INSERT INTO `user_leavemsg_reply` VALUES ('1d5e933023ac11eaaef9a7371ade0b99', '0348d84622fa11ea823e91afbb9bd661', '2019-12-21 12:41:12', '100', 'user', 'sss');
INSERT INTO `user_leavemsg_reply` VALUES ('633e75bc23ae11eaaef9a7371ade0b99', '5b7db21623ae11eaaef9a7371ade0b99', '2019-12-21 12:57:28', '1', 'admin', 'hello啊');
INSERT INTO `user_leavemsg_reply` VALUES ('e2d4d8c023a911eaaef9a7371ade0b99', '0348d84622fa11ea823e91afbb9bd661', '2019-12-21 12:25:15', '1', 'admin', 'as');
INSERT INTO `user_leavemsg_reply` VALUES ('fe19222823a211eaaef9a7371ade0b99', '0348d84622fa11ea823e91afbb9bd661', '2019-12-21 11:35:54', '1', 'admin', 'hello啊');
